...
(1) Appropriate work to cite, depending on citation types.
]

****************************************
NOTE: If using these corpora in published materials, please cite one or more of the following:

**For phrase structure & trace annotation:
...
Pearl, L. & Sprouse, J. 2019. Comparing solutions to the linking
problem using an integrated quantitative framework of language
acquisition. To appear in Language.  lingbuzz: https://ling.auf.net/lingbuzz/003913.
******************************************
